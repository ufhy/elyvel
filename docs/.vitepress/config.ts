        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Context', link: '/digging-deeper/context' },
          ...
          // than framework features — the same split Laravel's sidebar makes.
          {
            ...
            items: [
              ...
              { text: 'MCP (AI agents)', link: '/packages/mcp' },
              { text: 'Permission', link: '/packages/permission' },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Context', link: '/id/digging-deeper/context' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'MCP (agen AI)', link: '/id/packages/mcp' },
              { text: 'Permission', link: '/id/packages/permission' },
