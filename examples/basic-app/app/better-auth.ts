 ...
 * ORM. Email+password enabled; password-reset and email-verification links are
 * delivered through @elysia-ravel/mail (config/mail.ts). Add social
 * providers/plugins here as needed.
 */
