...
const SECTIONS: Section[] = [
  ...
  { file: 'mcp.md' },
  { file: 'core.md' },
  { file: 'support.md', requires: '@elyvel/support' },
  { file: 'database.md', requires: '@elyvel/database' },
  { file: 'validation.md', requires: '@elyvel/validation' },
  { file: 'auth.md', requires: '@elyvel/auth' },
  { file: 'permission.md', requires: '@elyvel/permission' },
  { file: 'cache.md', requires: '@elyvel/cache' },
  { file: 'queue.md', requires: '@elyvel/queue' },
  { file: 'events.md', requires: '@elyvel/events' },
  { file: 'mail.md', requires: '@elyvel/mail' },
  { file: 'notifications.md', requires: '@elyvel/notifications' },
  { file: 'broadcasting.md', requires: '@elyvel/broadcasting' },
  { file: 'storage.md', requires: '@elyvel/storage' },
  { file: 'scheduler.md', requires: '@elyvel/scheduler' },
  { file: 'i18n.md', requires: '@elyvel/i18n' },
  { file: 'view.md', requires: '@elyvel/view' },
